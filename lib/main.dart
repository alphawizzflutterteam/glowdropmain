...
Future<void> main() async {
  ...
  runApp(MultiProvider(
    providers: [
      ...
      ChangeNotifierProvider(create: (context) => di.sl<ReferalProvider>()),
      ...
      ChangeNotifierProvider(
          create: (context) => di.sl<TopRestaurantsProvider>()),
    ],
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //
    //     statusBarColor: Colors.white, // Set your primary color
    //     //  systemNavigationBarColor: Color(0xff0007a3), // Navigation bar
    //     //
    //     // statusBarColor: Color(0xff0007a3), // Set your primary color
    //     // // statusBarBrightness:
    //     //     Brightness.dark, // Alternatively, change this to Brightness.light
    //   ),
    //   child: MaterialApp(
    //     title: AppConstants.appName,
    //     navigatorKey: navigatorKey,
