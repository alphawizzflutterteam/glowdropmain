...
class LocationRepo {
  ...
  Future<ApiResponse> getZipcode() async {
    try {
      final response = await dioClient!.get(AppConstants.getZipcode);
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> getDeliveryRestrictedCityByZip(String zipcode) async {
    try {
      print(
          "  Uri ankush ${AppConstants.deliveryRestrictedget_cities}$zipcode");

      final response = await dioClient!
          .get('${AppConstants.deliveryRestrictedget_cities}$zipcode');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
