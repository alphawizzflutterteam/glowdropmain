...
class OrderRepo {
  ...
  Future<ApiResponse> getOrderFromOrderId(String orderID) async {
    try {
      final response =
          await dioClient!.get('${AppConstants.getOrderFromOrderId}$orderID');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> placeOrder(
    ...
    try {
      print(
          'placeOrder  ${AppConstants.orderPlaceUri}?address_id=$addressID&coupon_code=$couponCode&coupon_discount=$couponDiscountAmount&billing_address_id=$billingAddressId&order_note=$orderNote');
      final response = await dioClient!.get(
          '${AppConstants.orderPlaceUri}?address_id=$addressID&coupon_code=$couponCode&coupon_discount=$couponDiscountAmount&billing_address_id=$billingAddressId&order_note=$orderNote');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> offlinePaymentPlaceOrder(
    ...
    try {
      print(
          'paymenttype ${AppConstants.offlinePayment}?address_id=$addressID&coupon_code=$couponCode&coupon_discount=$couponDiscountAmount&billing_address_id=$billingAddressId&order_note=$orderNote&payment_by=$paymentBy&transaction_ref=$transactionId&payment_note=$paymentNote');
      final response = await dioClient!.get(
          '${AppConstants.offlinePayment}?address_id=$addressID&coupon_code=$couponCode&coupon_discount=$couponDiscountAmount&billing_address_id=$billingAddressId&order_note=$orderNote&payment_by=$paymentBy&transaction_ref=$transactionId&payment_note=$paymentNote');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> walletPaymentPlaceOrder(
    ...
    try {
      print(
        'online______${AppConstants.walletPayment}?address_id=$addressID&coupon_code=$couponCode&coupon_discount=$couponDiscountAmount&billing_address_id=$billingAddressId&order_note=$orderNote',
      );
      final response = await dioClient!.get(
        '${AppConstants.walletPayment}?address_id=$addressID&coupon_code=$couponCode&coupon_discount=$couponDiscountAmount&billing_address_id=$billingAddressId&order_note=$orderNote',
      );
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
  ...
  Future<bool> updateOrderPaymentDetails(
      String orderId, String transactionRef, String token) async {
  ...
  Future<ApiResponse> getShippingCostApi(String addressID) async {
    try {
      Map<String?, dynamic> data = {"address_id": addressID};
      final response = await dioClient!
          .post('${AppConstants.shippingChargesUri}', data: data);
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
