class OrderModel {
  ...
  OrderModel(
    ...
    if (otherCityShippingCost != null) {
      _otherCityShippingCost = otherCityShippingCost;
    }
  }
  ...
  double? get otherCityShippingCost => _otherCityShippingCost;
  ...
  OrderModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['other_city_shipping_cost'] != null) {
      _otherCityShippingCost = json['other_city_shipping_cost'].toDouble();
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['other_city_shipping_cost'] = _otherCityShippingCost;
