...
Future<void> init() async {
  ...
  sl.registerLazySingleton(() => ReferalRepo(dioClient: sl()));
  ...
  sl.registerLazySingleton(() => TopRestaurantsRepo(dioClient: sl()));


  // Provider
  sl.registerFactory(() => CategoryProvider(categoryRepo: sl()));
  sl.registerFactory(() => TopRestaurantsProvider(topRestaurantsRepo: sl()));
  ...
  sl.registerFactory(() => ReferalProvider(referalRepo: sl()));
  ...
  sl.registerFactory(() => PlanProvider(planRepo: sl()));
