...
class SplashScreenState extends State<SplashScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      Stack(
        children: [
          Expanded(child: Image.asset("assets/images/bacground.png",fit: BoxFit.cover,height: MediaQuery.of(context).size.height*100/100,)),
          Positioned(
            child: Container(
              ...
              child: Center(child: Image.asset("assets/images/logo_image.png")),
            ),
          ),
        ],
      )
      ...
      //     //     children: [
      //     //       Image.asset(Images.splashScreenLogo, height: 150.0, fit: BoxFit.scaleDown,
      //     //         width: 150.0,),
      //     //     ],
      //     //   ),
      //     // ),
