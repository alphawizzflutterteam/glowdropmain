      ...
      return Scaffold(
                                ...
                                onTap: () {
                                  for (ShippingModel shipping
                                      in Provider.of<CartProvider>(context,
                                          ...
                                          .shippingList!) {
                                    print(
                                        '------:${shipping.shippingIndex}/${shipping.groupId}/${shipping.shippingMethodList}');
                                  }
        ...
        body: Column(children: [
          CustomAppBar(
              ...
              isBackButtonExist: widget.fromWhere),
          cart.isXyz
              ? Padding(
                                                                    ...
                                                                    Flexible(
                                                                      child:
                                                                        ...
                                                                        (cart.shippingList == null ||
                                                                                cart.shippingList!.isEmpty ||
                                                                                cart.shippingList![index].shippingMethodList == null ||
                                                                                cart.shippingList![index].shippingMethodList!.isEmpty ||
                                                                                cart.chosenShippingList.isEmpty ||
                                                                                cart.shippingList![index].shippingIndex == null ||
                                                                                cart.shippingList![index].shippingIndex! < 0 ||
                                                                                cart.shippingList![index].shippingIndex! >= cart.shippingList![index].shippingMethodList!.length)
                                                                            ? 'test'
