...
class _SellerScreenState extends State<SellerScreen> {
  ...
  void _load() {
    ...
    Provider.of<ProductProvider>(context, listen: false).initSellerProductList(
        widget.seller!.seller!.id.toString(), 1, context);
  }
              ...
              children: [
                    ...
                    Row(children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text(
                                  '${widget.seller!.totalReview} ${getTranslated('reviews', context)}',
                                ...
                                const SizedBox(
                                    width: Dimensions.paddingSizeDefault),
                                Text(
                                  '${widget.seller!.totalProduct} ${getTranslated('products', context)}',
                                  style: titleRegular.copyWith(
                                      fontSize: Dimensions.fontSizeLarge,
                                      color:
                                          ColorResources.getReviewRattingColor(
                      ...
                      IconButton(
                        ...
                        icon: Image.asset(Images.chatImage,
                            color: ColorResources.sellerText,
                ...
                Padding(
                  padding: const EdgeInsets.only(
                      ...
                      right: Dimensions.paddingSizeExtraExtraSmall),
                  child: SearchWidget(
