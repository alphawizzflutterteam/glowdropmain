  ...
  Widget build(BuildContext context) {
    return
      ...
      child: GridView.builder(
        ...
        itemCount: 2,
        // isHomePage && topSellerProvider.topSellerList.length > 6? 6: topSellerProvider.topSellerList.length,
        shrinkWrap: true,
        physics: isHomePage
        ...
        itemBuilder: (BuildContext context, int index) {
          return SellerCard();
          // SellerCard(sellerModel: topSellerProvider.topSellerList[index]);
        },
      ),
    );
    // const SizedBox();
