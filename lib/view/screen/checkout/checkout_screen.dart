...
class CheckoutScreenState extends State<CheckoutScreen> {
  ...
  void initUI() {
    ...
    Future.delayed(Duration(seconds: 0), () async {
      ...
      try {
        int selected = int.parse(
                Provider.of<AuthProvider>(context, listen: false)
                    .getSaveIndex()) ??
            -1;
        Provider.of<OrderProvider>(context).setBillingAddressIndex(selected);
    ...
    //  if( Provider.of<OrderProvider>(context).billingAddressIndex == null ){
  ...
  Widget build(BuildContext context) {
    if (Provider.of<OrderProvider>(context).billingAddressIndex == null &&
        Provider.of<ProfileProvider>(context).billingAddressList.isNotEmpty) {
      Provider.of<OrderProvider>(context).setBillingAddressIndex(0);
      Provider.of<OrderProvider>(context).setAddressIndex(0);
      Provider.of<OrderProvider>(context).getShippingCost(
          context,
          Provider.of<ProfileProvider>(context)
              .billingAddressList[0]
              .id
              .toString());
    } //asd
              ...
              if (paymentMethods[order.paymentMethodIndex].name ==
                ...
                Provider.of<OrderProvider>(context, listen: false).placeOrder(
                    ...
                    widget.onlyDigital
                        ...
                        : Provider.of<ProfileProvider>(context, listen: false)
                            .billingAddressList[order.addressIndex!]
                ...
                showAnimatedDialog(context,
                  ...
                  return WalletPayment(
                    currentBalance: profile.reBalance,
                    orderAmount: _order +
                        widget.shippingFee -
                        widget.discount -
                        _couponDiscount! +
                                              ...
                                              Text(
                                                Provider.of<OrderProvider>(context)
                                                    ...
                                                    : Provider.of<ProfileProvider>(
                                                            context,
                                                            listen: false)
                                                        .billingAddressList[shipping.billingAddressIndex!]
                                                        .address!,
                                                style:
                                                    titilliumRegular.copyWith(
                                                        fontSize: Dimensions
                        ...
                        return Column(
                            ...
                            children: [
                              ...
                              AmountWidget(
                                  ...
                                  amount: PriceConverter.convertPrice(
                                      context, order.shippingCost ?? 0.0)),
                              Divider(
                                  height: 5,
                              ...
                              AmountWidget(
                                  ...
                                  //             _couponDiscount! +
                                  //             widget.tax)) +
                                  //     '+ ${order.shippingCost}${Provider.of<SplashProvider>(context, listen: false).myCurrency!.symbol}'
                                  ),
                            ]);
                      },
                    ),
