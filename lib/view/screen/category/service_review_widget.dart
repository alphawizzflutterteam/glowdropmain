...
class ServiceReviewWidget extends StatelessWidget {
  ...
  const ServiceReviewWidget({Key? key, required this.reviewModel}) : super(key: key);
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        (reviewModel.attachment != null && reviewModel.attachment!.isNotEmpty) ? SizedBox(
          ...
          child: ListView.builder(
            ...
            itemCount: List<String>.from(json.decode(reviewModel.attachment ?? '')).length,
...
class ServiceReviewShimmer extends StatelessWidget {
  const ServiceReviewShimmer({Key? key}) : super(key: key);
