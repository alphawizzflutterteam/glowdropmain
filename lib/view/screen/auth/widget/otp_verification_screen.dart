...
class VerificationScreen extends StatefulWidget {
  ...
  const VerificationScreen(this.tempToken, this.mobileNumber, this.email,
      {Key? key, this.fromForgetPassword = false, this.otp})
      : super(key: key);
...
class _VerificationScreenState extends State<VerificationScreen> {
  ...
  void initState() {
    super.initState();
    _startTimer();
    print("init state otp${widget.otp}");
  }
                                ...
                                onTap: () {
                                  if (widget.fromForgetPassword) {
                                    ...
                                    Provider.of<AuthProvider>(context,
                                        ...
                                        .then((value) {
                                      print(
                                          'mobile nuber---${widget.mobileNumber}');
                                      print('widgte otp-------${widget.otp}');
                                      print(
                                          'token----------${widget.tempToken}');
                                      print('----resend otp----${value.otp}');
