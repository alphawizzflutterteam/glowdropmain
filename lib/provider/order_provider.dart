...
class OrderProvider with ChangeNotifier {
  ...
  Future<void> initOrderList(BuildContext context) async {
    ...
    print("jhdvjsdhsdv___________${ApiResponse}");
    if (apiResponse.response != null &&
      ...
      apiResponse.response!.data.forEach((order) {
        ...
        if (orderModel.orderStatus == AppConstants.pending ||
            ...
            orderModel.orderStatus == AppConstants.outForDelivery ||
  ...
  Future<void> getOrderDetails(String orderID, String? languageCode) async {
    print("orrrddderrr");
    _orderDetails = null;
    notifyListeners();
  ...
  Future<void> getShippingCost(BuildContext context, String addressId) async {
    ApiResponse apiResponse = await orderRepo!.getShippingCostApi(addressId);
    if (apiResponse.response != null &&
        apiResponse.response!.statusCode == 200) {
      _shippingCost = apiResponse.response!.data['amount'] != null
          ? double.parse(apiResponse.response!.data['amount'].toString())
          : null;
    } else {
      if (context.mounted) {}
      ApiChecker.checkApi(apiResponse);
